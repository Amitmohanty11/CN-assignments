...
Project Structure
exp1_topologies.pkt: The main Cisco Packet Tracer file containing all three network designs.

output_exp1.txt: Documented ICMP ping results and behavioral observations.

report_exp1.pdf: Final lab report including objectives, screenshots, and conclusions.
...
2. Go to File > Open and select exp1_topologies.pkt.
